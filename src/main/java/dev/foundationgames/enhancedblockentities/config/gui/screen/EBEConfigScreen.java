package dev.foundationgames.enhancedblockentities.config.gui.screen;
...
import dev.foundationgames.enhancedblockentities.ReloadType;
import dev.foundationgames.enhancedblockentities.config.EBEConfig;
import dev.foundationgames.enhancedblockentities.config.gui.option.EBEOption;
import dev.foundationgames.enhancedblockentities.config.gui.option.TextPalette;
import dev.foundationgames.enhancedblockentities.util.EBEUtil;
import dev.foundationgames.enhancedblockentities.util.GuiUtil;
